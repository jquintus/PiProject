// https://learn.adafruit.com/custom-wireless-bluetooth-cherry-mx-gamepad/software
/*********************************************************************
...
int inputKeycodes[6] = { HID_KEY_H, HID_KEY_E, HID_KEY_L, HID_KEY_O, HID_KEY_BACKSPACE, HID_KEY_A };
  ...
  if ( ble.isConnected() )
  {
    for(int i=0; i<6; i++)
    {
      ...
      if ( digitalRead(inputPins[i]) == LOW )
      {
        ...
        Serial.print(F("sending codes: "));
        Serial.print(keyReport.keycode[0]);

        Serial.print(F(", "));
        Serial.print(keyReport.keycode[1]);

        Serial.print(F(", "));
        Serial.print(keyReport.keycode[2]);

        Serial.print(F(", "));
        Serial.print(keyReport.keycode[3]);

        Serial.print(F(", "));
        Serial.print(keyReport.keycode[4]);

        Serial.print(F(", "));
        Serial.println(keyReport.keycode[5]);
      } else
      {
